...
const output = {
  ...
  version: "1.0.0",
  repo: "Riverbraid-Interface-Gold",
  ring: 1,
  petal: "Interface-Gold",
  invariant: "INTERFACE_STATIONARY",
...
if (output.status !== "VERIFIED") {
  console.error("INTERFACE_GOLD_VERIFICATION_FAILED");
  process.exit(1);
}
console.log("INTERFACE_GOLD_VERIFICATION_SUCCESS");
